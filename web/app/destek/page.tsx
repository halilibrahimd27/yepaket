 ...
 * Yardım konuları.
 *
 * `query` alanı SSS aramasını doldurur: kartlar tıklanabilir görünüyordu ama
 * hiçbirinde `onClick` yoktu ve dokunuş hiçbir şey yapmıyordu.
 */
const topics = [
  { icon: ShoppingBag, title: "Sipariş & teslim", text: "Rezervasyon, teslim saati, iptal ve iade", query: "teslim" },
  { icon: ShieldCheck, title: "Hesap & ödeme", text: "Giriş, ödeme yöntemleri ve güvenlik", query: "ödeme" },
  { icon: Store, title: "İşletme desteği", text: "Paket, sipariş, panel ve hakediş", query: "işletme" },
  { icon: BookOpen, title: "YePaket rehberi", text: "Sürpriz paketler hakkında temel bilgiler", query: "paket" },
];
